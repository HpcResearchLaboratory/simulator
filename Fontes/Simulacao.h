...
class Simulacao {
  ...
  int idSim, ciclo, periodo, subciclo; string saidaSim; Seeds *seeds;
  Parametros *parametros; Ambiente *ambiente; Saidas *saidas;
  Humanos *humanos; Mosquitos *mosquitos;
  // double ref = 0;
  int idLira;
  ...
  Simulacao(
    ...
    Parametros *parametros, Ambiente *ambiente, int saidaSubciclo
  );
