...
struct Humano {
  ...
  __host__ __device__ Humano();
};

struct EstaMortoHumano {
  __host__ __device__ bool operator()(Humano humano);
};
...
struct MenorIdLocalidadeHumano {
  __host__ __device__ bool operator()(Humano humano1, Humano humano2);
};

struct GetIdLocalidadeHumano {
  __host__ __device__ int operator()(Humano humano);
};
...
public:
  ...
  Humano *humanos;
  int nHumanos;
  DVector<Humano> *humanosDev;
  Humano *PhumanosDev;
  DVector<int> *indHumanosDev;
  int *PindHumanosDev;
  int sizeIndHumanos;
...
private:
  ...
  void inicializarHumano(int id, int e, int x, int y, int l, int q, int s,
                         int fe, int t, int k, int st, int a);

  void inserirHumanos(int n, int estado, int sexo, int fe, int mov, int &i);
};
