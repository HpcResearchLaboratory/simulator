...
#define TAXA_MOBILIDADE_DIURNA_MOSQUITOS(s)                                    \
  (double)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 0 + s * 2],                   \
                       parametros[DESL_1_MOV_M + 1 + s * 2], (randPerc)))

#define TAXA_MOBILIDADE_NOTURNA_MOSQUITOS(s)                                   \
  (double)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 4 + s * 2],                   \
                       parametros[DESL_1_MOV_M + 5 + s * 2], (randPerc)))

#define RAIO_BUSCA_MACHO                                                       \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 8],                              \
                    parametros[DESL_1_MOV_M + 9], (randPerc)))

#define RAIO_BUSCA_PE                                                          \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 10],                             \
                    parametros[DESL_1_MOV_M + 11], (randPerc)))

#define INTERVALO_BUSCA_HUMANO                                                 \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 12],                             \
                    parametros[DESL_1_MOV_M + 13], (randPerc)))

#define RAIO_BUSCA_HUMANO                                                      \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 14],                             \
                    parametros[DESL_1_MOV_M + 15], (randPerc)))

#define RAIO_VOO_LEVY_CURTO                                                    \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 16],                             \
                    parametros[DESL_1_MOV_M + 17], (randPerc)))

#define RAIO_VOO_LEVY_LONGO                                                    \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 18],                             \
                    parametros[DESL_1_MOV_M + 19], (randPerc)))

#define TENTATIVAS_BUSCA_MACHO                                                 \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 20],                             \
                    parametros[DESL_1_MOV_M + 21], (randPerc)))

#define TENTATIVAS_BUSCA_PE                                                    \
  (int)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 22],                             \
                    parametros[DESL_1_MOV_M + 23], (randPerc)))

#define TAXA_MOBILIDADE_MOSQUITO_PARADO                                        \
  (double)(ENTRE_FAIXA(parametros[DESL_1_MOV_M + 24],                          \
                       parametros[DESL_1_MOV_M + 25], (randPerc)))
