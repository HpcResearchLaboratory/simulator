...
#define PROBABILIDADE_DISTRIBUICAO_MOSQUITOS                                   \
  (double)(ENTRE_FAIXA(parametros[DESL_0_INI_M + 32],                          \
                       parametros[DESL_0_INI_M + 33], randPerc))

#define PROBABILIDADE_DISTRIBUICAO_MOSQUITOS_(per)                             \
  (double)(ENTRE_FAIXA(parametros->parametros[DESL_0_INI_M + 32],              \
                       parametros->parametros[DESL_0_INI_M + 33], per))
