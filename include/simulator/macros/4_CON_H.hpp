...
#define TAXA_MORTE_NATURAL                                                     \
  (double)(ENTRE_FAIXA(parametros[DESL_4_CON_H + 0],                           \
                       parametros[DESL_4_CON_H + 1], (randPerc)))

#define TAXA_MORTE_NATURAL_(per)                                               \
  (double)(ENTRE_FAIXA(parametros->parametros[DESL_4_CON_H + 0],               \
                       parametros->parametros[DESL_4_CON_H + 1], (per)))
