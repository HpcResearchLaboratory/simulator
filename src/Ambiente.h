...
struct Controle {
  ...
  char tipoControle;
	int quadra, ciclo;
	double taxaMinMecanico, taxaMaxMecanico, taxaMinQuimico, taxaMaxQuimico, efeRes;
...
class Ambiente {
  ...
  // Complemento
  int sizeComp; double *comp;

  // Inserção de vacinados
  int sizeVacs; Vacinado *vacs;

  // Vetor climático
  int sizeCli; Climatico *cli;
  ...
  DVector<Controle> *contrDev; DVector<int> *indContrPontosDev;
  DVector<Posicao> *contrPontosDev; DVector<int> *indRaiosDev;
  ...
  Controle *PcontrDev; int *PindContrPontosDev;
  Posicao *PcontrPontosDev; int *PindRaiosDev; Posicao *PraiosDev;
