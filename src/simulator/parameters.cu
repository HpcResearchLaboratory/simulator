...
/*
  Construtor da classe Parâmetros, que armazena todos os parâmetros da
  simulação.
...
*/
int Parametros::getMemoriaGPU() { return (nParametros * sizeof(double)); }
...
*/
void Parametros::lerArquivo(string pasta, string nomeArquivo, int &i,
                            int nPar) {
