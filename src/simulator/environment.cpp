...
namespace simulator {
  ...
  auto Environment::from_dir(const fs::path input_path) -> Environment {
    ...
    std::transform(std::execution::seq, std::begin(blocks_groups_count_toml),
                   std::end(blocks_groups_count_toml),
                   std::back_inserter(blocks_groups_count),
    ...
    std::transform(std::execution::seq, std::begin(blocks_indexes_toml),
                   std::end(blocks_indexes_toml),
                   std::back_inserter(blocks_indexes),
                   [](auto const& block_index) {
                     return block_index.as_integer()->value_or(0);
                   });
    ...
    std::transform(std::execution::seq, std::begin(neighbors_indexes_toml),
                   std::end(neighbors_indexes_toml),
                   std::back_inserter(neighbors_indexes),
                   [](auto const& neighbor_index) {
    ...
    std::transform(std::execution::seq, std::begin(positions_indexes_toml),
                   std::end(positions_indexes_toml),
                   std::back_inserter(positions_indexes),
                   [](auto const& position_index) {
    ...
    std::transform(std::execution::seq, std::begin(position_region_indexes),
    ...
    std::transform(std::execution::seq, std::begin(frontiers_indexes_toml),
                   std::end(frontiers_indexes_toml),
                   std::back_inserter(frontiers_indexes),
                   [](auto const& frontier_index) {
    ...
    std::transform(std::execution::seq, std::begin(corners_indexes_toml),
                   std::end(corners_indexes_toml),
                   std::back_inserter(corners_indexes),
                   [](auto const& corner_index) {
    ...
    std::transform(std::execution::seq, std::begin(corner_center_indexes_toml),
    ...
    std::transform(std::execution::seq, std::begin(routes_indexes_toml),
                   std::end(routes_indexes_toml),
                   std::back_inserter(routes_indexes),
                   [](auto const& route_index) {
    ...
    std::transform(
      std::execution::seq, std::begin(routes_array_toml),
      std::end(routes_array_toml), std::back_inserter(routes_array),
      [](auto const& route) { return route.as_integer()->value_or(0); });
    ...
    std::transform(std::execution::seq, std::begin(paths_indexes_toml),
                   std::end(paths_indexes_toml),
    ...
    std::transform(std::execution::seq, std::begin(periods_indexes_toml),
                   std::end(periods_indexes_toml),
                   std::back_inserter(periods_indexes),
                   [](auto const& period_index) {
    ...
    std::transform(std::execution::seq,
                   std::begin(paths_age_groups_indexes_toml),
    ...
    std::transform(std::execution::seq,
                   std::begin(strategic_points_indexes_toml),
    ...
    std::transform(std::execution::seq, std::begin(focus_points_indexes_toml),
    ...
    std::transform(std::execution::seq, std::begin(focus_points_array_toml),
                   std::end(focus_points_array_toml),
                   std::back_inserter(focus_points_array),
                   [](auto const& focus_point) {
    ...
    std::transform(std::execution::seq, std::begin(complement_toml),
                   std::end(complement_toml), std::back_inserter(complement),
    ...
    std::transform(
      std::execution::seq, std::begin(cases_toml), std::end(cases_toml),
    ...
    std::transform(
      std::execution::seq, std::begin(control_toml), std::end(control_toml),
    ...
    std::transform(std::execution::seq, std::begin(control_points_indexes_toml),
    ...
    std::transform(std::execution::seq, std::begin(radius_indexes_toml),
                   std::end(radius_indexes_toml),
                   std::back_inserter(radius_indexes),
                   [](auto const& radius_index) {
