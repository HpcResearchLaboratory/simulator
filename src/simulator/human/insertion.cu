...
#include <simulator/macros/5_INS_H.hpp>
...
*/
__host__ __device__ void InsercaoHumanos::operator()(int id) {
  dre &seed = seeds[id];
...
InsercaoHumanos::inserirHumanosTrajeto(dre &seed, urd<double> &dist, int qtde,
                                       int st, int &i) {
...
*/
__host__ __device__ void
InsercaoHumanos::inicializarHumano(int id, int sd, int x, int y, int l, int q,
